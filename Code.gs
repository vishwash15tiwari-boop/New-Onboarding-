...
var CONFIG = {
  ...
  // External workbook holding Vendor Rating + OSV Status ("Open Marketplace Vendor
  // Scores"). The 0-10 rating is the "Denominator" column (= Score/10); OSV is the
  // "OSV Status" column. getQualityData resolves these by HEADER NAME, with the
  // positional VS_COLS (col H / col N) as a last-resort fallback. Run
  // debugVendorScoreSheet() to confirm the rating / OSV / GSTIN columns are detected.
  VENDOR_SCORE_SHEET_ID: '1wRYs0cB5APbbCozTFKW9w-1l5E6aVXPeg4nAF-5hKMM',   // "Open Marketplace Vendor Scores"
